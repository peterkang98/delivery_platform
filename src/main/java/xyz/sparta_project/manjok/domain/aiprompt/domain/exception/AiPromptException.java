 ...
 */
public class AiPromptException extends GlobalException {

    /**
     * ErrorCode만으로 예외 발생
     */
    public AiPromptException(ErrorCode errorCode) {
        super(errorCode);
    }
     ...
     */
    public AiPromptException(ErrorCode errorCode, String message) {
     ...
     */
    public AiPromptException(ErrorCode errorCode, Throwable cause) {
     ...
     */
    public AiPromptException(ErrorCode errorCode, String message, Throwable cause) {
